...
static inline uint32_t WalkBuildTerrainQuads(ChunkQuad outQuads[5])
{
    ...
    outQuads[1] = PackChunkQuad(0u, 0u, 0u, 0u, 2u, 1u, 64u, 1u);
    outQuads[2] = PackChunkQuad(63u, 0u, 0u, 1u, 2u, 1u, 64u, 1u);
    outQuads[3] = PackChunkQuad(0u, 0u, 0u, 2u, 2u, 64u, 1u, 1u);
    outQuads[4] = PackChunkQuad(0u, 63u, 0u, 3u, 2u, 64u, 1u, 1u);
    return 5u;
}
