...
LAIUE_TEST_ENTRY(VoxelRaycastCoreTestEntryPoint)
{
    ...
    VoxelRaycastHit hit;
    Expect(!VoxelRaycast(world, origin, positiveX, 10.0f, &hit),
    ...
    Expect(VoxelRaycast(world, origin, negativeX, 10.0f, &hit) &&
    ...
    Expect(!VoxelRaycast(world, origin, positiveX, 0.0f, &hit) &&
               !VoxelRaycast(world, origin, positiveX,
