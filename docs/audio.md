...
приложений на laiue. Windows-бэкенд использует Media Foundation в audio-only
режиме; декодирование, HTTPS-буферизация и вывод на выбранное системой
устройство не блокируют основной цикл приложения.
...
Проигрыватель следует создавать и уничтожать на одном управляющем потоке.
