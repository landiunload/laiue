...
function(laiue_assert_build_architecture)
    ...
    if(NOT LAIUE_BUILD_GRAPHICS)
        foreach(graphics_target IN ITEMS
            ...
            laiue_scene_math laiue_voxel_render)
    ...
    if(NOT LAIUE_BUILD_AUDIO_OUTPUT AND TARGET laiue_audio_output)
        message(FATAL_ERROR
            "Audio-output-disabled graph unexpectedly contains laiue_audio_output")
    endif()
