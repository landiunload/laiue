...
#if defined(LAIUE_BUILD_AUDIO) || defined(LAIUE_BUILD_AUDIO_PACK)
...
#if defined(LAIUE_BUILD_SCENE_STREAMING)
#define LAIUE_SCENE_STREAMING_API LAIUE_EXPORT
#else
#define LAIUE_SCENE_STREAMING_API LAIUE_IMPORT
#endif

#if defined(LAIUE_BUILD_SCENE_MATH)
#define LAIUE_SCENE_MATH_API LAIUE_EXPORT
#else
#define LAIUE_SCENE_MATH_API LAIUE_IMPORT
#endif

#if defined(LAIUE_BUILD_VOXEL_RAYCAST)
#define LAIUE_VOXEL_RAYCAST_API LAIUE_EXPORT
#else
#define LAIUE_VOXEL_RAYCAST_API LAIUE_IMPORT
#endif
