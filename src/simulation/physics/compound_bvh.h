 ...
 * (ничья у младшей оси), ключ сортировки — безопасно посчитанный центр
 * (ничья — по исходному индексу), сортировка — собственная heapsort без
 * выделения памяти. Глубина рекурсии Build не превышает log2(count), то
 * есть 31.
 */
