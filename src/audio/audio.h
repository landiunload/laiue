...
//
// Сам микшер о форматах файлов не знает: клип создаётся из готовых
// PCM-сэмплов. Чтение `.la`, WAV и звукопаков живёт в audio_pack.h, а
// разбор чужих контейнеров — во внутренней `media_support`. Границу
// стоит держать: у устройства вывода не должно появиться мнения о том,
// в каком контейнере приложение хранит звук.
